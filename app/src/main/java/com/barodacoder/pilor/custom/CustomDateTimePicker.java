...
import static com.barodacoder.pilor.R.id.tvCatName;

/**
 * Created by Vaibhavi on 5/7/2017.
 */
...
public class CustomDateTimePicker implements View.OnClickListener {
    ...
    private Button btn_setDate, btn_setTime;
    private TextView btn_set, btn_cancel;
    ...
    public View getDateTimePickerLayout() {
        ...
        button_params.setMargins(8,8,8,8);
        ...
        btn_setDate.setTextColor(activity.getResources().getColor(R.color.default_title_text_color));
        btn_setDate.setBackgroundResource(R.drawable.bg_selector_blue);
        ...
        btn_setTime.setTextColor(activity.getResources().getColor(R.color.default_title_text_color));
        btn_setTime.setBackgroundResource(R.drawable.bg_selector_blue);
        ...
        btn_set = new TextView(activity);
        btn_set.setLayoutParams(button_params);
        btn_set.setTextColor(activity.getResources().getColor(R.color.colorAccent));
       // btn_set.setBackgroundResource(R.drawable.bg_selector_blue);
        btn_set.setText("Set");
        btn_set.setTypeface(appData.getFontBold());
        btn_set.setGravity(Gravity.CENTER);
        btn_set.setId(SET);
        btn_set.setOnClickListener(this);

        btn_cancel = new TextView(activity);
        btn_cancel.setLayoutParams(button_params);
        btn_cancel.setTextColor(activity.getResources().getColor(R.color.colorAccent));
      //  btn_cancel.setBackgroundResource(R.drawable.bg_selector_blue);
        btn_cancel.setText("Cancel");
        btn_cancel.setTypeface(appData.getFontBold());
