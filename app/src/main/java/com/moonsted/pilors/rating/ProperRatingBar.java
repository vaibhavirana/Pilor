package com.moonsted.pilors.rating;
...
public class ProperRatingBar extends LinearLayout {
    ...
    public void addTick(Context context, int position) {
        if (useSymbolicTick) {
    ...
    private void addDrawableTick(Context context, int position) {
        ...
        LinearLayout.LayoutParams layoutParams =
                new LinearLayout.LayoutParams((int) getResources().getDimension(R.dimen.login_ll_password_margin_bottom)
                        , (int) getResources().getDimension(R.dimen.login_ll_password_margin_bottom));
    ...
    private void redrawTickSelection(ImageView tick, boolean isSelected) {
        if (isSelected) {
            ...
            tick.setAlpha(0.5f);
            //tick.setColorFilter(Color.argb(150, 155, 155, 155),   PorterDuff.Mode.SRC_ATOP);
            //tick.setColorFilter(R.color.transparent, PorterDuff.Mode.SRC_ATOP);
        }
    }
